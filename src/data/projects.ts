...
export const projects: Project[] = [
  {
    ...
    description:
      "Full-stack MERN e-commerce solution with payment integration and admin dashboard.",
    longDescription:
      "A comprehensive e-commerce platform built with the MERN stack, featuring user authentication, product management, shopping cart, payment processing via Stripe, order tracking, and a complete admin dashboard for inventory management.",
    technologies: [
      "React",
      "Node.js",
      "Express",
  ...
  },
  {
    ...
    longDescription:
      "A modern task management application that allows teams to collaborate in real-time, featuring drag-and-drop functionality, real-time notifications, file attachments, and detailed analytics.",
    technologies: [
      "Next.js",
      "React",
      "TypeScript",
