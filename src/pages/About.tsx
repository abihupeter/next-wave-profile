...
export default function About() {
  const handleDownloadResume = () => {
    ...
    link.download = 'abihu_Resume.pdf';
            ...
            <ScrollAnimation animation="slide-left">
              <div className="space-y-6">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  ...
                  React, Next.js, and modern web technologies, with a keen eye
                  for user experience and clean code.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  When I'm not coding, you'll find me exploring new
                  technologies, contributing to open-source projects, or
                  exploring different AIs. I believe in the power of technology
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button
                    variant="outline"
                    asChild
                    className="hover-lift hover:scale-105"
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <ScrollAnimation
                ...
                delay={index * 100}
              >
                <Card className="text-center hover-lift shadow-card hover:scale-105">
            ...
            {Object.entries(skillsByCategory).map(
              ([category, categorySkills], index) => (
                <ScrollAnimation
                  ...
                  delay={index * 150}
                >
                  <Card className="shadow-card hover-lift hover:scale-105">
                    <CardHeader>
